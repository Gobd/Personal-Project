...
angular.module("app").controller("homeCtrl",["$scope","locationFinder",function(o,n){o.searchByAddress=function(e){n.searchByAddress(e).then(function(n){o.coords=n.data})}}]);
angular.module("app").service("locationFinder",["$http","$q",function(t,o){function r(){var t=o.defer();return navigator.geolocation&&navigator.geolocation.getCurrentPosition(function(o){t.resolve(o)},function(o){t.reject(o)}),t.promise}this.getAddressFromCoords=function(){var o=r().then(function(o){return t({method:"GET",params:{lat:o.coords.latitude,"long":o.coords.longitude},url:"http://localhost:3001/getAddress"})});return o},this.searchByAddress=function(o){return t({method:"GET",params:{address:o},url:"http://localhost:3001/getCoords"})}}]);
