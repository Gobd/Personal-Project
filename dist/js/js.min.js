...
angular.module("app").service("locationService",["$http","$q","$location",function(t,r,e){function o(){var t=r.defer();return navigator.geolocation&&navigator.geolocation.getCurrentPosition(function(r){t.resolve(r)},function(r){t.reject(r)}),t.promise}this.getAddressFromCoords=function(){var r=o().then(function(r){return t({method:"GET",params:{lat:r.coords.latitude,"long":r.coords.longitude},url:"http://localhost:3001/getAddress"})});return r},this.searchByAddress=function(r){return t({method:"GET",params:{address:r},url:"http://localhost:3001/getCoords"})},this.addBrewery=function(r){return t({method:"POST",data:r,url:"http://localhost:3001/addBrewery"})},this.getBrewery=function(r){if(r){var o="?";for(var n in r)o+=n+"="+r[n]+"&";return e.url(o.slice(0,o.length-1)),t({method:"GET",params:r,url:"http://localhost:3001/getBrewery"})}return t({method:"GET",params:r,url:"http://localhost:3001/getBrewery"})}}]);
angular.module("app").directive("navDir",function(){return{restrict:"AE",replace:"true",templateUrl:"./partials/Directives/navDir.html",controller:["$scope","$auth",function(t,e){t.isAuthenticated=function(){return e.isAuthenticated()}}]}});
angular.module("app").directive("searchDir",function(){return{restrict:"AE",replace:"true",templateUrl:"./partials/Directives/searchDir.html",controller:"searchDirCtrl",scope:{brewery:"="}}});
angular.module("app").controller("searchDirCtrl",["$scope","locationService","$location","$rootScope",function(e,t,r,a){function n(e){return 0===Object.keys(e).length}t.getAddressFromCoords().then(function(t){e.coords={lat:t.data[0].latitude,lon:t.data[0].longitude},e.search||(e.search={}),e.search.location=t.data[0].city+", "+t.data[0].administrativeLevels.level1short}),a.$on("$locationChangeSuccess",function(){n(r.search())?t.getBrewery().then(function(t){e.search={},e.brewery=t.data}):t.getBrewery(r.search()).then(function(t){e.brewery=t.data})}),n(r.search())?t.getBrewery().then(function(t){e.brewery=t.data}):t.getBrewery(r.search()).then(function(t){e.search=r.search(),e.brewery=t.data}),e.getBrewery=function(r){t.getBrewery(r).then(function(t){e.brewery=t.data})},e.searchByAddress=function(r){t.searchByAddress(r).then(function(t){e.coords={lat:t.data[0].latitude,lon:t.data[0].longitude}})},e.details=function(e){console.log(e)}}]);
