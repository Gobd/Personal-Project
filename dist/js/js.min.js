...
angular.module("app").controller("homeCtrl",["$scope","locationService",function(t,a){a.getAddressFromCoords().then(function(a){t.respCoords={lat:a.data[0].latitude,lon:a.data[0].longitude},t.address=a.data[0].city+", "+a.data[0].administrativeLevels.level1short}),t.searchByAddress=function(e){a.searchByAddress(e).then(function(a){t.coords={lat:a.data[0].latitude,lon:a.data[0].longitude}})}}]);
angular.module("app").service("locationService",["$http","$q",function(t,o){function r(){var t=o.defer();return navigator.geolocation&&navigator.geolocation.getCurrentPosition(function(o){t.resolve(o)},function(o){t.reject(o)}),t.promise}this.getAddressFromCoords=function(){var o=r().then(function(o){return t({method:"GET",params:{lat:o.coords.latitude,"long":o.coords.longitude},url:"http://localhost:3001/getAddress"})});return o},this.searchByAddress=function(o){return t({method:"GET",params:{address:o},url:"http://localhost:3001/getCoords"})}}]);
