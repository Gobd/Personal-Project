...
angular.module("app").directive("navDir",function(){return{restrict:"AE",replace:"true",scope:{brewery:"=",search:"="},templateUrl:"./partials/Directives/navDir.html",controller:["$scope","$auth","locationService",function(e,t,r){e.isAuthenticated=function(){return t.isAuthenticated()},e.goHome=function(){r.getAddressFromCoords().then(function(t){e.coords={lat:t.data[0].latitude,lon:t.data[0].longitude},e.search={},e.search.location=t.data[0].formattedAddress,e.getBrewery(e.search)})},e.getBrewery=function(t){r.getBrewery(t).then(function(t){e.brewery=t.data})}}]}});
