...
angular.module("app").directive("navDir2",function(){return{restrict:"AE",replace:"true",templateUrl:"./partials/navDir2.html",controller:"NavbarCtrl"}});
angular.module("app").controller("NavbarCtrl",["$scope","$auth","locationService","$location","$rootScope",function(e,t,a,n,r){function o(e){return 0===Object.keys(e).length}e.isAuthenticated=function(){return t.isAuthenticated()},a.getAddressFromCoords().then(function(t){e.coords={lat:t.data[0].latitude,lon:t.data[0].longitude},e.search||(e.search={}),e.search.location=t.data[0].city+", "+t.data[0].administrativeLevels.level1short}),r.$on("$locationChangeSuccess",function(){o(n.search())?a.getBrewery().then(function(t){e.search={},e.brewery=t.data}):a.getBrewery(n.search()).then(function(t){e.brewery=t.data})}),o(n.search())?a.getBrewery().then(function(t){e.brewery=t.data}):a.getBrewery(n.search()).then(function(t){e.search=n.search(),e.brewery=t.data}),e.getBrewery=function(t){a.getBrewery(t).then(function(t){e.brewery=t.data})},e.searchByAddress=function(t){a.searchByAddress(t).then(function(t){e.coords={lat:t.data[0].latitude,lon:t.data[0].longitude}})},e.details=function(e){console.log(e)}}]);
