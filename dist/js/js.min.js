...
angular.module("app").controller("homeCtrl",["$scope","locationService",function(o,d){o.searchByAddress=function(e){d.searchByAddress(e).then(function(d){o.coords={lat:d.data[0].latitude,lon:d.data[0].longitude}})},o.add=function(o){o.loc={},o.loc.coordinates="",d.searchByAddress(o.address).then(function(e){o.loc.coordinates=[e.data[0].longitude,e.data[0].latitude],d.addBrewery(o).then(function(d){console.log(o.name+" added!")})})}}]);
...
angular.module("app").controller("NavbarCtrl",["$scope","$auth","locationService","$document",function(t,a,e,o){t.isAuthenticated=function(){return a.isAuthenticated()},e.getAddressFromCoords().then(function(a){t.coords={lat:a.data[0].latitude,lon:a.data[0].longitude},t.search={},t.search.location=a.data[0].city+", "+a.data[0].administrativeLevels.level1short}),t.searchDb=function(){}}]);
