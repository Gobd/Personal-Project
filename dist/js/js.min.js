...
angular.module("app").controller("NavbarCtrl",["$scope","$auth","locationService","$location","$rootScope",function(e,t,n,r,o){function c(e){return 0===Object.keys(e).length}e.isAuthenticated=function(){return t.isAuthenticated()},o.$on("$locationChangeSuccess",function(){console.log("func"),c(r.search())||e.getBrewery(r.search())}),c(r.search())?n.getBrewery().then(function(t){e.brewery=t.data}):n.getBrewery(r.search()).then(function(t){e.brewery=t.data}),e.getBrewery=function(t){n.getBrewery(t).then(function(t){e.brewery=t.data})},e.searchByAddress=function(t){n.searchByAddress(t).then(function(t){e.coords={lat:t.data[0].latitude,lon:t.data[0].longitude}})},e.details=function(e){console.log(e)}}]);
