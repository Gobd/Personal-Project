...
angular.module("app").controller("searchDirCtrl",["$scope","locationService","$location",function(e,t,a){function r(){t.getAddressFromCoords().then(function(t){e.coords={lat:t.data[0].latitude,lon:t.data[0].longitude},e.search={},e.search.location=t.data[0].city+", "+t.data[0].administrativeLevels.level1short,e.getBrewery(e.search)})}function n(e){return 0===Object.keys(e).length}n(a.search())?r():t.getBrewery(a.search()).then(function(t){e.search=a.search(),e.brewery=t.data}),e.getBrewery=function(a){t.getBrewery(a).then(function(t){e.brewery=t.data})},e.searchByAddress=function(a){t.searchByAddress(a).then(function(t){e.coords={lat:t.data[0].latitude,lon:t.data[0].longitude}})},e.details=function(e){console.log(e)}}]);
