...
angular.module("app").controller("homeCtrl",["$scope","locationService",function(o,e){o.searchByAddress=function(t){e.searchByAddress(t).then(function(e){o.coords={lat:e.data[0].latitude,lon:e.data[0].longitude}})}}]);
