...
angular.module("app").controller("NavbarCtrl",["$scope","$auth","locationService",function(e,t,n){e.isAuthenticated=function(){return t.isAuthenticated()},e.getBrewery=function(t){n.getBrewery(t).then(function(t){e.brewery=t.data})},e.searchByAddress=function(t){n.searchByAddress(t).then(function(t){e.coords={lat:t.data[0].latitude,lon:t.data[0].longitude}})},e.details=function(e){console.log(e)},e.results||n.getBrewery().then(function(t){e.brewery=t.data})}]);
